(results, waaila) => {
    ...
    * @score 50
    */
    const transactionsSummary = waaila.functions.summarizeGaResult(results['transactionData'][0]);
    const totalTax = +transactionsSummary['transactionTax']['total'];
    ...
    * @score 50
    */
    const totalShipping = +transactionsSummary['transactionShipping']['total'];
