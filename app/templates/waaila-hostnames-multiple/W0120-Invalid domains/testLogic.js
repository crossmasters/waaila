(results, waaila) => {
    ...
    */
    ...
    waaila.assert(totalHostnames == 0, 80).pass.message(assert_pass_message).fail.message(assert_fail_message + '<br/><br/> How to fix: <br/>' +  assert_fail_howtofix).table(hostnames).break;
}