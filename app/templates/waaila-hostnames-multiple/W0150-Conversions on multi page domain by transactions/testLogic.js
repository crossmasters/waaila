(results, waaila) => {
    ...
    */
    ...
    waaila.assert(wrongHostnames == 0, 80).pass.message(assert_pass_message).fail.message(assert_fail_message + '<br/><br/> How to fix: <br/>' +  assert_fail_howtofix).table(hostnames).break;
}
