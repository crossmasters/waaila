(results, waaila) => {
    /**
    * @const {number} lowerRatioThreshold - lower bound to share of visits last 7 days to weekly average visits last 28 days
    * @default 0.7
    */
    const lowerRatioThreshold = 0.7;
    /**
    * @const {number} lowerRatioThreshold - upper bound to share of visits last 7 days to weekly average visits last 28 days
    * @default 1.4
    */
    ...
    */
    ...
    const assert_pass_message = `Visits this week do not differ significantly from the weekly average in previous month (they are between ${lowerRatioThreshold*100} % and ${upperRatioThreshold*100} % of average visits for a week)`;
    const assert_fail_message = `Visits this week are not between ${lowerRatioThreshold*100} % and ${upperRatioThreshold*100} % of weekly average visits for last month`;
