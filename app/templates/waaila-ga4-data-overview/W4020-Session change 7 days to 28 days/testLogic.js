(results, waaila) => {
    ...
    */
    var sessions28d = 0;
    var sessions7d = 0;
    if ('metricValues' in results['totals'][0]){
        sessions28d = results['totals'][0]['metricValues'][0]['value'];
    }
    if ('metricValues' in results['totals'][1]){
        sessions7d = results['totals'][1]['metricValues'][0]['value'];
    }
