...
**test language:** en  
## Description:  
Observe the users’ interaction on your website per month. Measure the sessions made by users over the past month and compare the weekly average to the amount of session made during the latest week. The share of sessions should be within the expected range.  
## Constants:  
### lowerRatioThreshold
**type:** number  
...
**score:** 150  
**pass message:** Sessions this week do not differ significantly from last week (they are between ${lowerRatioThreshold\*100} and ${upperRatioThreshold\*100} % of average sessions for a week)  
