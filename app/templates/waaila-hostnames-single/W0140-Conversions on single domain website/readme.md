...
## Blocks:  
### 1 - warn
**description:** It checks presence of data for transactions by hostname  
**score:** 0  
### 2 - assert
...
**score:** 80  
**pass message:** Ratio of transactions on the most frequent hostname  (${hostName}) to all transactions is higher than ${sessionThreshold\*100} %  
**fail message:** Ratio of transactions on the most frequent hostname  (${hostName}) to all transactions is not higher than ${sessionThreshold\*100} %  
